class Solution:
    def twoSum(self, nums: List[int], target: int) -> List[int]:
        ...
        # did not understand the difference between a set and a dictionary
        # did not know that when looking into a hashmap, it checks the keys not the values
        # should walk through planned algorithm step by step with psuedo code before coding'''
